...
class Roomer(red_commands.Cog):
    ...
    async def on_voice_state_update(self, member, before, after):
        ...
        await thread.send(
            content="Welcome! Use the menu below to manage your voice room:",
            view=view
        )
...
class RoomSettingsView(discord.ui.View):
    ...
    @discord.ui.button(label="Unlock Room", style=discord.ButtonStyle.success, custom_id="unlock_room")
    ...
    @discord.ui.button(label="Rename Room", style=discord.ButtonStyle.primary, custom_id="rename_room")
...
class RenameRoomModal(discord.ui.Modal, title="Rename Voice Room"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message(f"Room renamed to **{self.new_name.value}**.", ephemeral=True)
